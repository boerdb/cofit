#!/usr/bin/env python3
"""Eerste keer: git clone op NEXT-server, build, PM2 (poort 3006)."""
...
REMOTE_DIR = os.environ.get("DEPLOY_DIR", "/var/www/cofit")
REPO = os.environ.get(
    "DEPLOY_REPO",
    "git@github.com:boerdb/cofit.git",
)
PORT = int(os.environ.get("DEPLOY_PORT", "3006"))
APP_NAME = os.environ.get("DEPLOY_APP", "cofit")
